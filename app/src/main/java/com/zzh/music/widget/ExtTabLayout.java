...
import com.zzh.music.utils.AnimationUtils;
import com.zzh.music.utils.ValueAnimatorCompat;
import com.zzh.music.utils.ViewUtils;
 ...
 * </pre>
 * You should set a listener via {@link #setOnTabSelectedListener(ExtTabLayout.OnTabSelectedListener)} to be
 ...
 */
@ViewPager.DecorView
public class ExtTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link ExtTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link ExtTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private ExtTabLayout.OnTabSelectedListener mSelectedListener;
    private final ArrayList<OnTabSelectedListener> mSelectedListeners = new ArrayList<>();
    private ExtTabLayout.OnTabSelectedListener mCurrentVpSelectedListener;
    ...
    private ExtTabLayout.TabLayoutOnPageChangeListener mPageChangeListener;
    ...
    public ExtTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExtTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        ThemeUtils.checkAppCompatTheme(context);
        ...
        TypedArray temp = context.obtainStyledAttributes(APPCOMPAT_CHECK_ATTRS);
        final boolean failed = !temp.hasValue(0);
        if (temp != null) {
            temp.recycle();
        }
        if (failed) {
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(ExtTabLayout.OnTabSelectedListener)} and
     * {@link #removeOnTabSelectedListener(ExtTabLayout.OnTabSelectedListener)}.
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable ExtTabLayout.OnTabSelectedListener listener) {
    ...
    /**
     * Add a {@link ExtTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via
     * {@link #removeOnTabSelectedListener(ExtTabLayout.OnTabSelectedListener)}.</p>
     *
     * @param listener listener to add
     */
    public void addOnTabSelectedListener(@NonNull ExtTabLayout.OnTabSelectedListener listener) {
    ...
    /**
     * Remove the given {@link ExtTabLayout.OnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(ExtTabLayout.OnTabSelectedListener)}.
     *
     * @param listener listener to remove
     */
    public void removeOnTabSelectedListener(@NonNull ExtTabLayout.OnTabSelectedListener listener) {
        mSelectedListeners.remove(listener);
    }

    /**
     * Remove all previously added {@link ExtTabLayout.OnTabSelectedListener}s.
     */
     ...
     */
    public void setTabMode(@ExtTabLayout.Mode int mode) {
        if (mode != mMode) {
            mMode = mode;
            applyModeAndGravity();
        }
    ...
    /**
     * Returns the current mode used by this {@link ExtTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @ExtTabLayout.Mode
     ...
     */
    public void setTabGravity(@ExtTabLayout.TabGravity int gravity) {
    ...
    /**
     * The one-stop shop for setting up this {@link ExtTabLayout} with a {@link ViewPager}.
     *
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new ExtTabLayout.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            mCurrentVpSelectedListener = new ExtTabLayout.ViewPagerOnTabSelectedListener(viewPager);
            ...
            if (mAdapterChangeListener == null) {
                mAdapterChangeListener = new ExtTabLayout.AdapterChangeListener();
            }
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new ExtTabLayout.PagerAdapterObserver();
            }
    ...
    //--------------add listener 2016/12/22
    public interface LocationListener{
        void location(float x,float y,int tabHeight);
    }

    private ExtTabLayout.LocationListener locationListener;

    public void setLocationListener(ExtTabLayout.LocationListener locationListener) {
        this.locationListener = locationListener;
    }
    //------------add listener end

    protected class TabView extends LinearLayout implements OnLongClickListener {
        private Tab mTab;
     ...
     * necessary calls back to the provided {@link ExtTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<ExtTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(ExtTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final ExtTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link ExtTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements ExtTabLayout.OnTabSelectedListener {
