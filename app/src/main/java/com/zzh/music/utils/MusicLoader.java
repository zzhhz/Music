...
public class MusicLoader {
    ...
    public void insert(Music music) {
        ...
        values.put(MediaStore.MediaColumns.DATA, music.getMusicPath());
        values.put(MediaStore.MediaColumns.TITLE, music.getMusicName());
        values.put(MediaStore.MediaColumns.MIME_TYPE, mimeType);
        values.put(MediaStore.MediaColumns.SIZE, music.getMusicDuration());
        values.put(MediaStore.Audio.Media.DISPLAY_NAME, music.getMusicName());
        values.put(MediaStore.Audio.Media.DATA, music.getMusicPath());
        values.put(MediaStore.Audio.Media.TITLE, music.getMusicName());
